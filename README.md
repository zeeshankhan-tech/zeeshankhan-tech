...
Python for ML and AI, PyTorch, Scikit-learn, XGBoost, Pandas, NumPy, FastAPI, Docker, SQL / PostgreSQL, AWS (EC2, ECR), LLM inference and orchestration (Ollama, n8n), generative AI systems, XAI, and practical MLOps workflows for deploying and maintaining AI models.
...
![XAI](https://img.shields.io/badge/XAI-4B0082?style=for-the-badge&logo=ai&logoColor=white)  
